...
public class Lemire_Fk_BIC_Decompr_exp {
    ...
    protected static void execute(String path, String Fk_To_decompr_in, String scenario, String approx_Suffix) throws InterruptedException, IOException {
        ...
        try {
            ...
            if (scenario.compareTo("a") == 0) {
                ...
                System.out.println("BIC DECOMPR" + "\t" + "Read .nfo file from: " + path + Fk_To_decompr_in + FS_SEPARATOR + Fk_To_decompr_in + approx_Suffix + nfo_EXT);
            }
            else {
                ...
                System.out.println("BIC DECOMPR" + "\t" + "Read .nfo file from: " + path + Fk_To_decompr_in.substring(0, Fk_To_decompr_in.length() -3) + FS_SEPARATOR + Fk_To_decompr_in.substring(0, Fk_To_decompr_in.length() -3) + approx_Suffix + nfo_EXT);
            }
        ...
        while (i < num_fragments) {
            ...
            try {
                ...
                if (scenario.compareTo("a") == 0) {
                    ...
                    System.out.println("BIC DECOMPR" + "\t" + "Write data to: " + path + Fk_To_decompr_in + FS_SEPARATOR + Fk_To_decompr_in + approx_Suffix + "_" + i + Fk_decompr_EXT);
                }
                else {
                    ...
                    System.out.println("BIC DECOMPR" + "\t" + "Write data to: " + path + Fk_To_decompr_in.substring(0, Fk_To_decompr_in.length() -3) + FS_SEPARATOR + Fk_To_decompr_in.substring(0, Fk_To_decompr_in.length() -3) + approx_Suffix + "-Gk_" + i + Fk_decompr_EXT);
                }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Lemire_Fk_BIC_Decompr_exp.execute("/home/ubuntu-fs-server/IdeaProjects/TradeOff/exp-fragments/", "Staph-k4-DSK-verbatim", "b", "");
    }
}
