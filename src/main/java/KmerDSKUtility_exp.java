...
public class KmerDSKUtility_exp {
    ...
    protected static void execute (String path, String DSK_in, int mode_Sorting, String DSK_out_sort_fragments, int b, int debug) throws InterruptedException, IOException {
        ...
        while ((line = dict_in.readLine()) != null) {
            ...
            if (count_file < num_rows_file) {
                ...
                /*
                //FIXME: apply here the k-mers file correction for correct operation of the SPRING specialized compressor
                if (k > 7) {
        ...
        */
        ...
        // FIXME: Creation, info loading and finalisation of data information file (NFO) for reconstruction of entire files
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        /*
        // Example of input:
            /home/user/IdeaProjects/TradeOff/exp-fragments/                 (String)
            Staph-k4-DSK                                                    (String)
            1                                                               (int)
        ...
        KmerDSKUtility_exp.execute("/home/user/IdeaProjects/TradeOff/exp-fragments/", "Staph-k4-DSK", 1, "Staph-k4-DSK-lexicogr", 5, 1);
    }
}
