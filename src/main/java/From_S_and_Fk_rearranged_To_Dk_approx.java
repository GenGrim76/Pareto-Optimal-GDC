...
public class From_S_and_Fk_rearranged_To_Dk_approx {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        */
        ...
        From_S_and_Fk_rearranged_To_Dk_approx.execute("/home/ubuntu-fs-server/IdeaProjects/TradeOff/exp-automazione/", "Staph","Staph-k4-ESS", 4, "Staph-k4-Bijection", 10, 1);
    }
}
