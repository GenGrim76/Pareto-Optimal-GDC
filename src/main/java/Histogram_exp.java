...
public class Histogram_exp {
    ...
    protected static void execute(String path, String exp_name, int debug) throws InterruptedException, IOException {
        ...
        //FIXME: Lettura informazioni .nfo per ricavare le informazioni: total_rows, k, num_rows_file, num_fragments
        ...
        while (i < num_fragments) {
            ...
            //FIXME: Apertura in lettura frammento delle frequenze
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        /* Example:
            ...
            0   ->  /home/ismartlab/IdeaProjects/TradeOff/exp-automazione/StaphAU/k4/       (initial path)
            1   ->  StaphAU-DSK-k4-verbatim                                                 (Fk folder with fragments)
            2   ->  0/1                                                                     no/yes verbose mode

         */

        Histogram_exp.execute("/home/ismartlab/IdeaProjects/TradeOff/exp-automazione/AssPlants/k16/", "AssPlants-DSK-k16-verbatim", 1);
    }
}
