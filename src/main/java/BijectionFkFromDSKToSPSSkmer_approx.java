...
public class BijectionFkFromDSKToSPSSkmer_approx {
    ...
    protected static void execute (String path, String exp, String ESS_in, int k, String DSK_in_sort_fragments, String Fk_out_Bijection, int num_blocks, int debug) throws InterruptedException, IOException {
        ...
        /*
            (F'k)
            0   ->  /home/nome-utente/IdeaProjects/TradeOff/exp-automazione/Staph/k4/   (initial path to read and write files)
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        /*
            ...
            7   ->  0/1                         no/yes verbose mode
        */
        BijectionFkFromDSKToSPSSkmer_approx.execute("/home/ubuntu-fs-server/IdeaProjects/TradeOff/exp-fragments/", "Staph", "Staph-k4-ESS", 4, "Staph-k4-DSK-verbatim", "Staph-k4-bijection", 10, 1);
    }
}
